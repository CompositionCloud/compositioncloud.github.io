...
window.onload = function onload() {
    ...
    function main() {
        document.body.innerHTML =
                "<div class='center'>" +
                "   <p><button id='title' class='title-black'>d9-tgoc_aCVPsG</button><br>" +
                "   <span id='subtitle'>diagrams9 — the_gesture_of_creation; audioControlledVideoPlayer and simpleGranulator</span></p>" +
        ...
        function initCanvas() {
            ...
            if (window.innerWidth >= window.innerHeight) {
                scale = Math.min(window.innerHeight * 1.6, window.innerWidth) / 1280;
            } else {
                scale = window.innerWidth / 1280;
            }
            
            main_canvas.height = Math.floor(scale * 650 / 9) * 9;
            main_canvas.width = main_canvas.height * 16 / 9;

            title.className = "title";
            title.style.fontSize = Math.round(scale * 48) + "px";
            
            subtitle.className = "subtitle";
            subtitle.style.fontSize = Math.round(scale * 25) + "px";
    ...
    d9_tgoc[0].src = "d9-tgoc_aCVPsG/images/d9-1-tgoc.jpg";
    ...
    function loadImages() {
        ...
        if (i < 8) {
            d9_tgoc[i].src = "d9-tgoc_aCVPsG/images/d9-" + (i + 1) + "-tgoc.jpg";
